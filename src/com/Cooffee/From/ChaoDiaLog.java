...
public class ChaoDiaLog extends javax.swing.JDialog {
    ...
    void init() {
        ...
        new Timer(20, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                int value = kkk.getValue();
                if(value < 100){
                    kkk.setValue(value + 1);
                }
                else{
    ...
    private void initComponents() {
        ...
        kkk = new javax.swing.JProgressBar();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Chào");

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/Cooffee/iicon/ChaoDiaLog.png"))); // NOI18N

        kkk.setStringPainted(true);
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(0, 0, 0)
                .addComponent(kkk, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
    ...
    private javax.swing.JProgressBar kkk;
