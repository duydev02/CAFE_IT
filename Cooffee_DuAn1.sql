...
--INSERT INTO Employee (UsernameEmp, Password,NameEmp, vaitro, Gender,Phone,Email,Address,Hinh) VALUES (?, ?, ?, ?,?,?,?,?,?)
----UPDATE Employee SET Password=?, NameEmp=?, VaiTro=?, Gender=?,Birthday=?,Phone=?,Email=?,Address=?,Hinh=? WHERE UsernameEmp=?
...
Insert into Employee values('hoanghung','123456',N'Võ Ngọc Hoàng Hưng',1,1,'2000/9/11','0337645534','hoanghungfcb28@gmail.com',N'Quận 12, TP Hồ Chí Minh','h1.PNG')
Insert into Employee values('duytan','123456',N'Trần Duy Tân',1,1,'2000/9/11','0124221177','duytan@gmail.com',N'Tphcm','h2.PNG')
Insert into Employee values('nhatkhanh','123456',N'Huỳnh Nhật Khánh',1,1,'2000/9/11','0932212333','khanhnhat@gmail.com',N'15 Tân Bình','h3.PNG')
Insert into Employee values('tuanhau','123456',N'Nguyễn Tuấn Hậu',1,1,'2000/9/11','01227971919','tuanhau@gmail.com',N'9 Bình Tân ','h4.PNG')
Insert into Employee values('tuanmanh','123456',N'Nguyễn Tuấn Manh',1,1,'2000/9/11','0909123456','tuanmanh@gmail.com',N'12 Lê Hồng Phong','h5.PNG')
Insert into Employee values('huuphat','123456',N'Mai Hữu Phát',1,1,'2000/9/11','0909123456','huuphat@gmail.com',N'12 Lê Hồng Phong','h6.PNG')
go
